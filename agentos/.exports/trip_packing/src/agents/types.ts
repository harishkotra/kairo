...
export type ScreenSectionItem = {
  title: string;
  subtitle?: string;
  badge?: string;
  /** Emoji or Ionicons name for visual variety (e.g. "🔥", "checkmark-circle") */
  icon?: string;
  /** Numeric value for stats sections */
  value?: string;
  /** Color hint for the item (hex or named) */
  color?: string;
};
...
export type ScreenSection = {
  ...
  title?: string;
  /** Longer descriptive text for hero / detail sections */
  description?: string;
  /** Eyebrow text (hero sections) */
  kicker?: string;
  /** Call-to-action label */
  cta?: string;
  /** Accent color hint for the section */
  color?: string;
  items?: ScreenSectionItem[];
};
